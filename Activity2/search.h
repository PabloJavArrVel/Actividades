...
// =================================================================
template <class T>
int sequentialSearch(std::vector<T> &v, T key) {
...
// =================================================================
template <class T>
std::vector <int> sequentialSearchII(std::vector<T> &v, T key) {
	int comparisons = 0;
	for (int i = 0; i < v.size(); i++) {
		if (v[i] == key) {
			comparisons++;
...
// =================================================================
template <class T>
int binarySearch(std::vector<T> &v, T key) {
	int low, high, mid;
	low = 0;
	high = v.size() - 1;
	while (low <= high) {
...
// =================================================================
template <class T>
std::vector <int> binarySearchII(std::vector<T> &v, T key) {
	int low, high, mid;
	int comparisons=0;
	low = 0;
	high = v.size() - 1;
